...
from app.persistence.models import ReplayRunRecord
from app.replay.types import EquityPoint, ReplayMetrics, ReplayRun, ReplayTradeResult
...
class ReplayRepository:
    ...
    def _to_run(self, record: ReplayRunRecord) -> ReplayRun:
